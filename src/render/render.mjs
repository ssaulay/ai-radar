...
<header><h1>ai-radar</h1><span class="sub">généré le ${esc(now.slice(0, 16).replace('T', ' '))} UTC · ${json.topics.length} sujets actifs · ${okCount}/${srcHealth.length} sources OK · <a href="radar.json">JSON</a> · <a href="radar.xml">RSS</a></span></header>
